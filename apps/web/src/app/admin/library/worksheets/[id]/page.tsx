...
export default function WorksheetEditorPage() {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      toast.success(isNew ? 'Worksheet created!' : 'Saved!');
      router.push('/admin/library');
    } catch {
  ...
  return (
    <div className="max-w-2xl mx-auto pb-20">
      ...
      <div className="space-y-5">
        <section className="bg-white rounded-2xl border border-gray-100 p-6 shadow-sm space-y-4">
          ...
          <div>
            ...
            <Input
              ...
              placeholder="e.g. Biology Basics Worksheet"
            />
          </div>
          <div>
        ...
        <section className="bg-white rounded-2xl border border-gray-100 p-6 shadow-sm space-y-4">
          <h2 className="font-bold text-gray-800">Worksheet File (PDF)</h2>
          {fileUrl ? (
            ...
            >
              ...
              <p className="text-xs text-gray-400 mt-1">PDF recommended</p>
            </div>
          )}
          <input
            ref={fileRef}
